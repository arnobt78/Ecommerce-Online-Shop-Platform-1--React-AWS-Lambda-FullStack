...
export const FilterBar = ({ setShow }: FilterBarProps) => {
  ...
  return (
    <section className="filter">
      <div
        ...
        role="dialog"
      >
        <h5 id="drawer-disable-body-scrolling-label" className="text-base font-medium text-gray-500 uppercase dark:text-gray-400">
          Filters
        </h5>
        <button
          ...
          className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-700 rounded-lg text-sm p-1.5 absolute top-2.5 right-2.5 inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
        >
        ...
        <div className="py-4 overflow-y-auto">
          <ul className="text-slate-700 dark:text-slate-100">
            <li className="mt-1 mb-5">
              <p className="font-medium my-1">Sort by</p>
              <div className="flex items-center my-1">
                <input
                  ...
                  value=""
                  name="price-sort"
                  className="w-4 h-4 text-sky-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600"
                />
                <label htmlFor="price-sort-1" className="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                  Price - Low to High
                </label>
              </div>
              <div className="flex items-center my-1">
                <input
                  ...
                  className="w-4 h-4 text-sky-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600"
                />
                <label htmlFor="price-sort-2" className="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                  Price - High to Low
                </label>
              </div>
            </li>
            <li className="mt-1 mb-5">
              ...
              <div className="flex items-center my-1">
                <input
                  ...
                  className="w-4 h-4 text-sky-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600"
                />
                <label htmlFor="rating-sort-1" className="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                  4 Stars & Above
                </label>
              </div>
              <div className="flex items-center my-1">
                <input
                  ...
                  className="w-4 h-4 text-sky-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600"
                />
                <label htmlFor="rating-sort-2" className="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                  3 Stars & Above
                </label>
              </div>
              <div className="flex items-center my-1">
                <input
                  ...
                  className="w-4 h-4 text-sky-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600"
                />
                <label htmlFor="rating-sort-3" className="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                  2 Stars & Above
                </label>
              </div>
              <div className="flex items-center my-1">
                <input
                  ...
                  className="w-4 h-4 text-sky-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600"
                />
                <label htmlFor="rating-sort-4" className="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                  1 Stars & Above
                </label>
              </div>
            </li>
            <li className="mt-1 mb-5">
              <span className="font-medium">Other Filters</span>
              <div className="flex items-center my-1">
                <input
                  ...
                  type="checkbox"
                  value=""
                  className="w-4 h-4 text-sky-600 bg-gray-100 rounded border-gray-300 dark:bg-gray-700 dark:border-gray-600"
                />
                <label htmlFor="best-seller" className="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                  Best Seller Only
                </label>
              </div>
              <div className="flex items-center my-1">
                <input
                  ...
                  className="w-4 h-4 text-sky-600 bg-gray-100 rounded border-gray-300 dark:bg-gray-700 dark:border-gray-600"
                />
                <label htmlFor="only-instock" className="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                  INSTOCK Only
                </label>
              </div>
            </li>
